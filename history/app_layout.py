            ...
            html.Div(
                ...
                children=[
                    dash_table.DataTable(
                        ...
                        columns=[
                            {'name': '编号', 'id': 'id'},
                            {'name': '停留时间', 'id': 'count', 'type': 'numeric',
                             'format': Format(nully='N/A', precision=2, scheme=Scheme.decimal, sign=Sign.parantheses,
                                              symbol=Symbol.yes, symbol_suffix=u'小时')},
                            {'name': '网页地址', 'id': 'url'},
                            {'name': '网页标题', 'id': 'title'}
            ...
            html.Div(
                ...
                children=[
                    html.Span(
                        ...
                        style={'font-weight': 'bold', 'color': 'red', 'line-height': '34px', 'margin-right': '10px',
                               'float': 'left'}
                    ),
