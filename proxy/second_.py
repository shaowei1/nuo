...
def run(_arg=None):
    ...
    if _arg == 'webm':
        ...
        urls = ['https://www.pornhub.com/users/11xiaojia/videos/recent',
                'https://www.pornhub.com/users/11xiaojia/videos/recent?page=2',
                'https://www.pornhub.com/users/11xiaojia/videos/recent?page=3',
                'https://www.pornhub.com/users/11xiaojia/videos/recent?page=4',
                'https://www.pornhub.com/users/11xiaojia/videos/recent?page=5',
                'https://www.pornhub.com/users/11xiaojia/videos/recent?page=6']
        for url in urls:
            list_page(url)
